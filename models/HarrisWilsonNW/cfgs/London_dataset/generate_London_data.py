...
data_cfg = cfg.get("parameter_space").get("HarrisWilsonNW").get("Data").get("synthetic_data")
network = torch.from_numpy(pd.read_csv("data/HarrisWilson/London_data/exp_times.csv", header=0, index_col=0).to_numpy())
